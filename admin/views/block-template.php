...
<body id="error-page">
	...
	<div class="wp-error-actions">
		...
		<p class="wp-error-footer">
			<?php esc_html_e( 'Protected by IP2Location Sentinel', 'ip2location-sentinel' ); ?> &bull; <a href="https://www.ip2location.io" target="_blank" rel="noopener noreferrer">IP2Location.io</a>
		</p>
	</div>
</body>
</html>
